    ...
    <div id="login-show" class="login stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="/user/login" method="get" commandName="user" role="form" autocomplete="off">
                    <div class="input-field col s12">
                        <input type="text" name="phone" required="required" pattern="^1[0-9]{10}$" class="validate   ng-invalid ng-invalid-required ng-valid-pattern "  placeholder="请输入用户名">
                    </div>
                    <div class="input-field col s12">
                        <input type="password" name="password"  placeholder="请输入密码" required="required" class="validate   ng-invalid ng-invalid-required" />
                    </div>
    ...
    <div id="signup-show" class="signup stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="/user/addUser" method="get" commandName="user" role="form">
                    <div class="input-field col s12">
                    ...
                    <a href="">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到郑轻Aurora校园二手工坊。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——Aurora二手工坊</p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入Aurora，你的大学，应更精彩。</p>
                            </ul>
                            <div class="logoimg">
