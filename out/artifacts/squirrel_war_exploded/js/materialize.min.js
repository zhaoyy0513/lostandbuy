                                            ...
                                            jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
                                                ...
                                                return function (a, b, c, d) {
                                                    ...
                                                    function k(a) {
                                                        if (a) {
                                                            ...
                                                            c > 1e4 && (t.State.calls = e(t.State.calls));
                                                            for (var f = 0; c > f; f++) if (t.State.calls[f]) {
                                                                var h = t.State.calls[f], i = h[0], j = h[2], n = h[3],
                                                                    o = !!n, q = null;
                                                                n || (n = t.State.calls[f][3] = b - 16);
                                                                for (var r = Math.min((b - n) / j.duration, 1), s = 0, u = i.length; u > s; s++) {
                                                                    var w = i[s], y = w.element;
                                                    ...
                                                    return t.State.isMobile || c.hidden === d || c.addEventListener("visibilitychange", function () {
                                                        ...
                                                        t.Redirects["fade" + b] = function (a, c, e, f, g, h) {
                                                            var i = m.extend({}, c), j = {opacity: "In" === b ? 1 : 0},
                                                                k = i.complete;
                                                ...
                                                function B(a, b) {
                                                    ...
                                                    var f = c.firstInput, g = c.firstMultiple,
                                                        h = g ? g.center : f.center, i = b.center = F(d);
                                                ...
                                                function D(a, b) {
                                                    ...
                                                    if (b.eventType != Ba && (i > xa || h.velocity === d)) {
                                                        var j = h.deltaX - b.deltaX, k = h.deltaY - b.deltaY,
                                                            l = G(i, j, k);
                                                ...
                                                var ia = ["", "webkit", "moz", "MS", "ms", "o"],
                                                    ja = b.createElement("div"), ka = "function", la = Math.round,
                                                    ma = Math.abs, na = Date.now, oa = 1,
                                                    pa = /mobile|tablet|ip(ad|hone|od)|android/i,
                                                    qa = "ontouchstart" in a, ra = v(a, "PointerEvent") !== d,
                                                    sa = qa && pa.test(navigator.userAgent), ta = "touch", ua = "pen",
                                                    va = "mouse", wa = "kinect", xa = 25, ya = 1, za = 2, Aa = 4,
                                                    Ba = 8, Ca = 1, Da = 2, Ea = 4, Fa = 8, Ga = 16, Ha = Da | Ea,
                                                    Ia = Fa | Ga, Ja = Ha | Ia, Ka = ["x", "y"],
                                                    La = ["clientX", "clientY"];
                                                y.prototype = {
                                                    handler: function () {
                                                    }, init: function () {
                                                ...
                                                a.MSPointerEvent && (Ra = "MSPointerDown", Sa = "MSPointerMove MSPointerUp MSPointerCancel"), j(N, y, {
                                                    handler: function (a) {
                                                        var b = this.store, c = !1,
                                                            d = a.type.toLowerCase().replace("ms", ""), e = Pa[d],
                                                ...
                                                var Ya = v(ja.style, "touchAction"), Za = Ya !== d, $a = "compute",
                                                    _a = "auto", ab = "manipulation", bb = "none", cb = "pan-x",
                                                    db = "pan-y";
                                                T.prototype = {
                                                    set: function (a) {
                                                        ...
                                                        if (!Za) {
                                                            ...
                                                            var d = this.actions, e = q(d, bb), f = q(d, db),
                                                                g = q(d, cb);
                                                ...
                                                V.prototype = {
                                                    ...
                                                    defaults: {pointers: 1}, attrTest: function (a) {
                                                        ...
                                                        var b = this.state, c = a.eventType, d = b & (fb | gb),
                                                            e = this.attrTest(a);
                                            ...
                                            Vel = $ ? $.Velocity : Velocity, function (a) {
                                                a.fn.collapsible = function (b) {
                                                    ...
                                                    return b = a.extend(c, b), this.each(function () {
                                                        ...
                                                        var g = a(this), h = a(this).find("> li > .collapsible-header"),
                                                ...
                                                a.fn.extend({
                                                    openModal: function (c) {
                                                        ...
                                                        var e = {
                                                            ...
                                                            h = a('<div class="lean-overlay"></div>'), i = ++b;
                                                    ...
                                                    closeModal: function (c) {
                                                        var d = {out_duration: 250, complete: void 0}, e = a(this),
                                                            f = e.data("overlay-id"), g = a("#" + f);
                                                        ...
                                                        if (!a(this).hasClass("initialized")) {
                                                            ...
                                                            g.wrap(h), g.on("click", function () {
                                                                var f = g.parent(".material-placeholder"),
                                                                    h = window.innerWidth, i = window.innerHeight,
                                                ...
                                                a.fn.parallax = function () {
                                                    ...
                                                    return this.each(function (c) {
                                                        function d(c) {
                                                            ...
                                                            var f = e.children("img").first(), g = f.height(),
                                                                h = g - d, i = e.offset().top + d, j = e.offset().top,
                                                                k = a(window).scrollTop(), l = window.innerHeight,
                                                                m = k + l, n = (m - j) / (d + l), o = Math.round(h * n);
                                                ...
                                                var b = {
                                                    init: function () {
                                                        return this.each(function () {
                                                            ...
                                                            a(window).width();
                                                            b.width("100%");
                                                            var c, d, e = b.find("li.tab a"), f = b.width(),
                                                                g = b.find("li").first().outerWidth(), h = 0;
                                                            ...
                                                            "mouseenter.tooltip": function (a) {
                                                                ...
                                                                g = void 0 === g || "" === g ? b.delay : g, c = 0, e = setInterval(function () {
                                                                    if (c += 10, c >= g && d === !1) {
                                                                        ...
                                                                        var a = h.outerWidth(), b = h.outerHeight(),
                                                                            e = h.attr("data-position"),
                                                                            i = j.outerHeight(), l = j.outerWidth(),
                                                                            m = "0px", n = "0px", o = 8;
                                                                        "top" === e ? (j.css({
                                                ...
                                                function b(b, c, d, e) {
                                                    ...
                                                    return a.each(g, function (a, g) {
                                                        if (g.height() > 0) {
                                                            var h = g.offset().top, i = g.offset().left,
                                                                j = i + g.width(), k = h + g.height(),
                                                                l = !(i > c || e > j || h > d || b > k);
                                                            l && f.push(g)
                                                        }
                                                    }), f
                                                ...
                                                function c() {
                                                    ++j;
                                                    var c = f.scrollTop(), d = f.scrollLeft(), e = d + f.width(),
                                                        g = c + f.height(),
                                                ...
                                                a(document).ready(function () {
                                                    ...
                                                    a("input[autofocus]").siblings("label, i").addClass("active"), a(document).on("change", c, function () {
                                                        ...
                                                        var b = void 0 !== a.attr("length"),
                                                            c = parseInt(a.attr("length")), d = a.val().length;
                                                ...
                                                var b = {
                                                    init: function (b) {
                                                        ...
                                                        return b = a.extend(c, b), this.each(function () {
                                                            ...
                                                            var e, f = a(this), g = f.find("ul.slides").first(),
                                                                h = g.find("li"), i = g.find(".active").index();
                                                            ...
                                                            f.hammer({prevent_default: !1}).bind("pan", function (a) {
                                                                if ("touch" === a.gesture.pointerType) {
                                                                    ...
                                                                    var b = a.gesture.direction, c = a.gesture.deltaX,
                                                ...
                                                Materialize.fadeInImage = function (b) {
                                                    ...
                                                    a(".dismissable").each(function () {
                                                        a(this).hammer({prevent_default: !1}).bind("pan", function (d) {
                                                            if ("touch" === d.gesture.pointerType) {
                                                                var e = a(this), f = d.gesture.direction,
                                                                    g = d.gesture.deltaX, h = d.gesture.velocityX;
                                                    ...
                                                    window.addEventListener("scroll", function () {
                                                        ...
                                                        if (b) {
                                                            ...
                                                            for (var c = window.pageYOffset + window.innerHeight, d = 0; d < a.length; d++) {
                                                                var e = a[d], f = e.selector, g = e.offset,
                                                                    h = e.callback, i = document.querySelector(f);
                                                                if (null !== i) {
                                                ...
                                                function b(f, g, i, l) {
                                                    ...
                                                    var s = !1,
                                                        ...
                                                        v = a.extend({}, b.klasses(), u.klass), w = a(f),
                                                        x = function () {
                                                            return this.start()
                                                        }, y = x.prototype = {
                                                            constructor: x,
                                                ...
                                                function c(a, b) {
                                                    var c = this, d = a.$node[0], e = d.value,
                                                        f = a.$node.data("value"), g = f || e,
                                                ...
                                                c.prototype.set = function (a, b, c) {
                                                    ...
                                                    var e, f, g, h, i = b.isArray(c), j = b.isPlainObject(c),
                                                        k = this.item.view;
                                                    if (i || j) {
                                                    ...
                                                    var e, g, h, i, j = this, k = c,
                                                        l = d && d.interval ? d.interval : 1, m = -1 === j.item.enable,
                                                    ...
                                                    var b = this, c = b.settings, g = b.item, h = g.now, i = g.select,
                                                        j = g.highlight, k = g.view, l = g.disable, m = g.min,
                                                        n = g.max, o = function (a, b) {
                                                ...
                                                function b() {
                                                    var b = +a(this).attr("length"), c = +a(this).val().length,
                                                        d = b >= c;
